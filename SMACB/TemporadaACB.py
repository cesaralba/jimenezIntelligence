...
class TemporadaACB:
    ...
    #     return result
    #
    # def clasifLiga(self, fecha=None, abrevList: Optional[Set[str]] = None, parcial: bool = False, datosLR=None) ->
    # List[
    #     infoClasifEquipo]:
    #     teamList = abrevList
    ...
    #
    #     datosClasifEquipos: List[infoClasifEquipo] = [self.clasifEquipo(abrEq=eq, fecha=fecha, gameList=gameList)
    #     for eq
    #                                                   in teamList]
    #
    #     if datosLR is None:

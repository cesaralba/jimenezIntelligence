...
REPORTLEYENDAS = {'+/-': {'etiq': '+/-', 'leyenda': 'Cambio en la anotación con él en el campo', 'formato': '{.2f}'},
                  ...
                  'A/BP': {'etiq': 'Asist / Perd', 'leyenda': 'Asistencias dadas por balón perdido',
                           'formato': '{:.2f}'},
                  'A/TC-C': {'etiq': '% Can de As', 'leyenda': 'Canastas por cada tiro de campo', 'formato': '{:.2f}'},
                  ...
                  'eff-t3': {'etiq': '% Puntos 3', 'leyenda': 'Porcentaje de puntos por tiro de 3',
                             'formato': '{:.2f}%'},
                  'EffRebD': {'etiq': 'Ef reb Def', 'leyenda': '% Rebotes defensivos', 'formato': '{:.2f}%'},
                  'EffRebO': {'etiq': 'Ef reb Of', 'leyenda': '% Rebotes ofensivos', 'formato': '{:.2f}%'},
                  ...
                  'DER': {'etiq': 'Rating Def', 'leyenda': 'Puntos rec por posesión', 'formato': '{:.2f}'},
                  'OERpot': {'etiq': 'OERpot', 'leyenda': 'OERpot', 'formato': '{:.2f}'},
                  'DERpot': {'etiq': 'DERpot', 'leyenda': 'DERpot', 'formato': '{:.2f}'},
                  'P': {'etiq': 'P', 'leyenda': 'Puntos', 'formato': '{:.2f}'},
                  'Prec': {'etiq': 'P rec', 'leyenda': 'Puntos recibidos', 'formato': '{:.2f}'},
                  ...
                  't2/tc-C': {'etiq': '%Can 2', 'leyenda': '%Canastas de 2pts', 'formato': '{:.2f}'},
                  't2/tc-I': {'etiq': '%Tiros 2', 'leyenda': '%Tiros de 2 pts', 'formato': '{:.2f}'},
                  'T3%': {'etiq': 'T3%', 'leyenda': 'T3%', 'formato': '{:.2f}'},
                  'T3-C': {'etiq': 'T3-C', 'leyenda': 'T3-C', 'formato': '{:.2f}'},
                  'T3-I': {'etiq': 'T3-I', 'leyenda': 'T3-I', 'formato': '{:.2f}'},
                  't3/tc-C': {'etiq': '%Can 3', 'leyenda': '%Canastas de 3pts', 'formato': '{:.2f}'},
                  't3/tc-I': {'etiq': '%Tiros 3', 'leyenda': '%Tiros de 3pts', 'formato': '{:.2f}'},
                  'TAP-C': {'etiq': 'Tap rec', 'leyenda': 'Tapones recibidos', 'formato': '{:.2f}'},
                  'TAP-F': {'etiq': 'Tapones', 'leyenda': 'Tapones', 'formato': '{:.2f}'},
                  'TC%': {'etiq': 'TC%', 'leyenda': 'TC%', 'formato': '{:.2f}'},
                  'TC-C': {'etiq': 'TC-C', 'leyenda': 'TC-C', 'formato': '{:.2f}'},
                  'TC-I': {'etiq': 'TC-I', 'leyenda': 'TC-I', 'formato': '{:.2f}'},
                  'utilizados': {'etiq': 'Usados', 'leyenda': 'Jugadores utilizados', 'formato': '{:.2f}'},

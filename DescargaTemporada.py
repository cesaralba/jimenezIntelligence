...
if nuevosPartidos:
    resumenPartidos = [" * %s (%s) %i - %i %s (%s) " % (temporada.Partidos[x].EquiposCalendario['Local'],
                                                        ...
                                                        temporada.Partidos[x].CodigosCalendario['Visitante'])
                       for x in sorted(list(nuevosPartidos))]
